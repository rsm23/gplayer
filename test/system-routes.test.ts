...
describe('legacy-compatible system routes', () => {
  ...
  it('serves the Node landing page and its generator assets', async () => {
    ...
    expect(page.body).not.toContain('data-share-network')
    expect(page.body).not.toContain('data-share-more')
    ...
    expect(script.body).not.toContain('https://www.facebook.com/sharer/sharer.php')
    expect(script.body).not.toContain('https://twitter.com/intent/tweet')
    ...
    expect(style.body).not.toContain('.public-share-rail')
  ...
  it('applies escaped Site Settings branding and colors to every public shell', async () => {
    ...
    for (const response of [dmca, missing]) {
      ...
      expect(response.body).not.toContain('data-share-network')
      expect(response.body).not.toContain('data-share-more')
  ...
  it('serves the sitemap alias and installable web-app assets', async () => {
    ...
    expect(worker.body).toContain("gplayer-node-public-v34")
